...
ces_selected <- ces2021_converted %>% select(all_of(feature_vars))
head(ces_selected)
```
...
Both 'cps21_age' and 'Duration__in_seconds_' represented that these features are highly associated with voting behavior and may be valuable for predictive modeling.
