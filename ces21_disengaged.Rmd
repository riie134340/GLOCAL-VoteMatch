...
ces_selected$disengaged_count <- with(ces_selected,
  as.integer(pes21_follow_pol >= 3) +
  as.integer(cps21_interest_gen_1 <= 2) +
  as.integer(cps21_interest_elxn_1 <= 2) +
  as.integer(cps21_news_cons %in% c(1, 7)) +
  as.integer(cps21_govt_confusing == 5)
)
```
...
```{r}
ces_selected$low_quality_count <- with(ces_selected,
  as.integer(cps21_duplicates_pid_flag == 1) +
  as.integer(cps21_duplicate_ip_demo_flag == 1) +
  as.integer(pes21_speeder_low_quality == 1) +
  as.integer(pes21_duplicates_pid_flag == 1) +
  as.integer(cps21_inattentive == 1) +
  as.integer(pes21_inattentive == 1)
)
```
